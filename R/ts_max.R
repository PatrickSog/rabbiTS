...
#'@examples max<-ts_max(my_input)
#'@details Function will take .tif raster data and calculate the maximum for each layer


ts_max<-function(my_input){
  ...
  val_max <- (cellStats(in_stack, stat='max'))
