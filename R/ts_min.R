...
#'@examples min<-ts_min(my_input)
#'@details Function will take .tif raster data and calculate the minimum for each layer


ts_min<-function(my_input){
  ...
  val_min <- (cellStats(in_stack, stat='min'))
